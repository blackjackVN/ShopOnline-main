...
<html>
  ...
  <a href="../Ecommerce/profile.jsp">
    <h2 class="active">Buyer Information</h2>
  </a>
    ...
    <form method="POST" action="updateBuyer?id=<%= product_id %>&numberof=<%= product_numberof %>&selectedSize=<%= product_size %>&cartTotal=<%= cartSubtotal %>">
    ...
    <br><br><br><br>
    <button class="signin" type="submit" name="action" value="updateBuyer">
      Update
    </button> 
    <button class="signin" type="submit" name="action" value="exitBuyer">
      Exit
    </button>
    </form>
